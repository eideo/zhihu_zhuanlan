package com.bxbxbai.zhuanlan.data;
...
public final class ImageCacheManager {
    ...
    //内存的1/8当做Cache
    private static final int MEM_CACHE_SIZE = ONE_MB * ((ActivityManager)App.getContext()
                ...
                if(response.getBitmap() != null ){
                    if(!isImmediate && defaultImage != null) {
                        ...
                        TransitionDrawable transitionDrawable = new TransitionDrawable(new Drawable[]{
                                defaultImage,
                                new BitmapDrawable(App.getContext().getResources(), response.getBitmap())
                        });
